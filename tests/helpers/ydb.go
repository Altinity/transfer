...
var (
	...
	YDBTestMultikeyValues1 = []interface{}{
		...
		time.Duration(4291747200000000 - 1), // this is the largest possible: https://github.com/altinity/transfer/arcadia/contrib/ydb/core/ydb_convert/ydb_convert.cpp?rev=r13809522#L445
	}
