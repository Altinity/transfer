...
func (j *JSON) Scan(src any) error { // Implements sql.Scanner
	...
	case []byte: // In the driver JSON is represented with sql.RawBytes, not a string: https://github.com/altinity/transfer/arcadia/vendor/github.com/go-sql-driver/mysql/fields.go?rev=10013250#L181-183
