...
func extractVerboseError(err error) (value string, ok bool) {
	...
	case fmt.Formatter:
		...
		// https://github.com/altinity/transfer/arcadia/vendor/golang.org/x/xerrors/adaptor.go?rev=r4433436#L46
...
// Reference how library zap makes this: https://github.com/altinity/transfer/arcadia/vendor/go.uber.org/zap/zapcore/error.go?rev=r12909533#L73
