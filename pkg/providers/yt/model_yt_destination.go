...
type YtDestination struct {
	...
	// * we were unable to find table schema in cache for some reason: https://github.com/altinity/transfer/arcadia/transfer_manager/go/pkg/providers/yt/sink/sink.go?rev=11063561#L482-484
