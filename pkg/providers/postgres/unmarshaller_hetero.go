...
import (
	...
	"github.com/altinity/transfer/pkg/util/strict"
...
func expectedAnyCast(value any, colSchema *abstract.ColSchema, connInfo *pgtype.ConnInfo) (any, error) {
	...
	case driver.Valuer:
		...
		result, err = v.Value()
	case [16]byte:
		// this should never appear, but has been present since https://github.com/altinity/transfer/review/757334/files/2#file-/trunk/arcadia/transfer_manager/go/pkg/storage/pg/scanner.go:R21
		result, err = uuid.FromBytesOrNil(v[:16]).String(), nil
	case *net.IPNet:
		// this should never appear, but has been present since https://github.com/altinity/transfer/review/1204645/files/2#file-transfer_manager/go/pkg/storage/pg/scanner.go:R98
		result, err = unmarshalIPNet(v)
	case net.IPNet:
		// this should never appear, but has been present since https://github.com/altinity/transfer/review/1204645/files/2#file-transfer_manager/go/pkg/storage/pg/scanner.go:R98
		result, err = unmarshalIPNet(&v)
	case byte:
		// unclear what this is for, but has been present since https://github.com/altinity/transfer/review/757334/files/2#file-/trunk/arcadia/transfer_manager/go/pkg/storage/pg/scanner.go:R19
...
func expectedStringCast(value any) (any, error) {
	...
	case string:
		// this should never appear, but has been present since https://github.com/altinity/transfer/review/757334/files/2#file-/trunk/arcadia/transfer_manager/go/pkg/storage/pg/scanner.go:R24
		result, err = v, nil
	default:
