...
import (
	...
	"github.com/altinity/transfer/pkg/providers/postgres/utils"
	"github.com/altinity/transfer/pkg/storage"
	"github.com/altinity/transfer/pkg/transformer/registry/rename"
...
func (s *PgSource) isPreferReplica(transfer *model.Transfer) bool {
	...
	// - It can be used only on heterogeneous transfers - bcs "for homo there are some technical restrictions" (https://github.com/altinity/transfer/review/4059241/details#comment-5973004)
